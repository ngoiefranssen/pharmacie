...
<div class="">
    <div class="md:grid md:grid-cols-0 md:gap-6">
        <p class="te                <h1>Ajouter un patient</h1>
            xt-sm leading-center"></p>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mb-4 xl:w-100">
                        <textarea class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="ordered_description" name="ordered_description" rows="3" placeholder="Entrer la description...."></textarea>
                    </div>
                </div>

            </div>
            </div>
            <div class="px-2 py-3 bg-gray-50 text-right sm:px-3">
