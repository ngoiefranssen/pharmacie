...
<div class="mt-10 sm:mt-0">
    <div class="md:grid md:grid-cols-0 md:gap-6">
      ...
      <div class="mt-5 md:mt-0 md:col-span-2 flex justify-center pt-14">
        ...
        <form action="{{ route('pharmacists.store') }}" method="POST" class="" enctype="multipart/form-data">
            @csrf
            @method('post')
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @enderror
                  <input type="text" name="name_pharmacist" id="name_pharmacist" placeholder="Enter name cashier" autocomplete="name_pharmacist" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    @error('first_name_pharmacist')
                        <div class="text-blue-600">{{ $message }}</div>
                    @enderror
                  <input type="text" name="first_name_pharmacist" id="first_name_pharmacist" placeholder="Enter first name...." autocomplete="first_name_pharmacists" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
