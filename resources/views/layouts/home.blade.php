                ...
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="/medications" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                            <i class="fab fa-product-hunt md:pr-3"></i>Medications
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="/ordereds" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-users md:pr-3" aria-hidden="true"></i>Ordereds
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="/invoices" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
                            <i class="fa fa-users md:pr-3 bg-center" aria-hidden="true"></i>Invoices
                        </a>
                    </li>
                     <li class="mr-3 flex-1">
                        <a href="/patients" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-users md:pr-3" aria-hidden="true"></i>Patients
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="/cashiers" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-socks md:pr-3"></i>Cashiers
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="/pharmacists" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
                            <i class="fab fa-cart-shopping md:pr-3"></i>Pharmacists
                        </a>
                    </li>
                </ul>
            </div>
